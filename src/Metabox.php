...
?>
        <div style="margin-top:20px;">
            ...
            <br>
            <textarea 
                id="template-html" rows="10" cols="50" 
                name="wp_emailkit_template_html" 
                style="width:100% !important;"
            ><?php esc_html_e(get_post_meta($object->ID, "wp_emailkit_template_html", true))?></textarea>
    ...
    public function save()
    {
        ...
        if (isset($post->ID)) {
            ...
            if (isset($_POST["wp_emailkit_template_type"])) :
                ...
                if (in_array($template_type, array_keys($this->template_types))) :
